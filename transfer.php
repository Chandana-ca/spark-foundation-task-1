		 ...
		 function random_function()
            {
				...
				if(a==="Pooja"){
				      var arr=["Sneha","Arjun","Raju","Monika","Ravi","Anusha","Harsha","Rishi","Ankitha"];
				 }
				 else if(a==="Sneha"){
					var arr=["Pooja","Arjun","Raju","Monika","Ravi","Anusha","Harsha","Rishi","Ankitha"];
				}
				else if(a==="Arjun"){
					var arr=["Pooja","Sneha","Raju","Monika","Ravi","Anusha","Harsha","Rishi","Ankitha"];
				}
				else if(a==="Raju"){
					var arr=["Pooja","Sneha","Arjun","Monika","Ravi","Anusha","Harsha","Rishi","Ankitha"];
                                }
				else if(a==="Monika"){
                                        var arr=["Pooja","Sneha","Arjun","Raju","Ravi","Anusha","Harsha","Rishi","Ankitha"];
				}
				else if(a==="Ravi"){
                                        var arr=["Pooja","Sneha","Arjun","Raju","Monika","Anusha","Harsha","Rishi","Ankitha"];
				}
				else if(a==="Anusha"){
					var arr=["Pooja","Sneha","Arjun","Raju","Monika","Ravi","Harsha","Rishi","Ankitha"];
				}
				else if(a==="Harsha"){
					var arr=["Pooja","Sneha","Arjun","Raju","Monika","Ravi","Anusha","Rishi","Ankitha"];
				} 
				else if(a==="Rishi"){
					var arr=["Pooja","Sneha","Arjun","Raju","Monika","Ravi","Anusha","Harsha","Ankitha"];
				}
				else if(a==="Ankitha"){
				        var arr=["Pooja","Sneha","Arjun","Raju","Monika","Ravi","Anusha","Harsha","Rishi"];
				}
                var string="";
